...
const SearchResultImageItem: FC<Props> = ({
  ...
  return (
    <Dialog>
      <DialogTrigger>
        <div className="border dark:border-neutral-800 rounded-lg px-5 pt-5 pb-14 hover:bg-gray-50 dark:hover:bg-neutral-800 transition-colors grow max-w-xs cursor-pointer">
          <div className="max-w-[260px] mx-auto">
            <div className="relative h-[140px]">
              ...
              <div className="absolute w-full">
                ...
                <div className="whitespace-nowrap overflow-hidden text-ellipsis text-xs text-gray-400 dark:text-neutral-500">
                  {url}
                </div>
              </div>
            </div>
      ...
      <DialogContent title={title} className="w-[300px] box-content">
        <div className="relative">
          ...
          <span className="absolute bottom-2 left-2 bg-white/90 dark:bg-neutral-900/90 rounded-md font-mono px-3 py-1 shadow-sm">
            {imgSizeW} x {imgSizeH}
          </span>
        </div>
        <div className="text-gray-400 dark:text-neutral-500 text-xs mb-3 mt-5 break-all">{url}</div>
